...
import com.ll.gooHaeYu.domain.member.member.service.MemberDetailService;
...
public class TokenProvider {
    ...
    public Authentication getAuthentication(String token) {
        ...
        MemberDetail memberDetail = (MemberDetail)memberDetailService.loadUserByUsername(claims.getSubject());
        memberDetail.setAuthorities(authorities);
