											...
											<div class="flex-grow text-left">
												...
												<p>
													{#if application.approve === true}
														<span
															class="badge"
															style="border-color: #ffe647; background-color: #ffe5477a;">승인</span
														>
													{:else if application.approve === false}
														<span
															class="badge"
															style="border-color: #80776c; background-color: #80776c9c;"
															>미승인</span
														>
													{:else}
														<span
															class="badge"
															style="border-color: #82cf23; background-color: #82cf2369;"
															>진행중</span
														>
													{/if}
												</p>
