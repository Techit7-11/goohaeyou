		...
		<div class="flex justify-between items-center">
			...
			<div class="flex items-center">
				{#if jobPostDetailDto?.author === rq.member.username}
					<button class="btn btn-outline btn-xs mr-2" on:click={editPost}>수정하기</button> <!-- 수정 -->
					<button class="btn btn-outline btn-xs btn-error" on:click={deletePost}>삭제하기</button>
