...
public enum ErrorCode {
    ...
    JOB_APPLICATION_NOT_EXISTS(HttpStatus.NOT_FOUND, "지원서가 존재하지 않습니다."),
    ...
    // chat
    CHATROOM_NOT_EXISTS(HttpStatus.NOT_FOUND,"해당 채팅방은 존재하지 않습니다."),
    MESSAGE_NOT_EXISTS(HttpStatus.NOT_FOUND, "해당 메세지는 존재하지 않습니다."),
    ...
    COMMENT_NOT_EXISTS(HttpStatus.NOT_FOUND, "해당 댓글은 존재하지 않습니다."),
    ...
    // notification
    NOTIFICATION_NOT_EXISTS(HttpStatus.NOT_FOUND, "해당 알림은 존재하지 않습니다."),
