...
최저시급 인상으로 급증하는 단기 고용 수요에 맞춰, 구인자와 구직자를 실시간으로 연결할 수 있는 플랫폼으로 개발되었습니다.
...
내 주변 공고 찾기 기능을 통해 현재 위치에서 가까운 일자리를 탐색할 수 있습니다.

매칭된 구인자와 구직자는 1:1 실시간 채팅을 통해 소통할 수 있습니다. <br/>
수당 결제 및 정산 시스템으로 빠르고 투명하게 지급 처리가 이루어집니다.

웹 푸시 알림을 통해 지원자 현황, 댓글, 지원서 승인 등의 정보를 실시간으로 받아볼 수 있습니다.
...
[Domain] Policy     Domain Service (핵심 도메인 로직)   
                      ⬇        ⬇
[Domain]     Repository I/F   PaymentProcessor(I/F)  (DIP 적용) 
                                    (구현)
